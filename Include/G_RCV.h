...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	__packed struct Req8AD_Rcv01	// старт оцифровки
	{
		__packed struct Req
		{
			byte 	len;
	...
	__packed struct Rsp8AD_Rcv01	// старт оцифровки
	{
		byte adr;
		byte func;
		word crc;  
	...
	__packed struct Req8AD_Rcv02	// чтение вектора
	{
		__packed struct Req
		{
			byte 	len;
	...
	__packed struct Rsp8AD_RcvHdr02	// чтение вектора
	{
		u16 rw; 
		u32 cnt; 
		u16 gain; 
	...
	__packed struct Rsp8AD_Rcv02	// чтение вектора
	{
		Rsp8AD_RcvHdr02 hdr;
	...
	__packed struct  Req8AD_Rcv03	// установка периода дискретизации вектора и коэффициента усиления
	{ 
		__packed struct Req
		{
			byte 	len;
	...
	__packed struct  Rsp8AD_Rcv03	// установка периода дискретизации вектора и коэффициента усиления
	{ 
		byte adr;
		byte func;
		word crc; 
	...
	__packed struct  Req8AD_Rcv04	// установка коэффициента усиления
	{ 
		__packed struct Req
		{
			byte 	len;
	...
	__packed struct  Rsp8AD_Rcv04	// установка периода дискретизации вектора и коэффициента усиления
	{ 
		byte	adr;
		byte	func;
		u16 	maxAmp[4];
